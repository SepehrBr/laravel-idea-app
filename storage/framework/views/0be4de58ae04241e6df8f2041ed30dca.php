...
<?php $component->withAttributes([]); ?>
    <form method="POST" action="<?php echo e(route('register_store')); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <div class="flex flex-wrap justify-center">
        ...
        <a href="<?php echo e(route('auth.google')); ?>" class="bg-red-600 w-full mt-3 rounded-lg text-white text-center self-center px-3 py-2 my-2 mx-2"><i class="fab fa-laravel"></i>Register Using Google</a>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\roocket\Back\PHP\Laravel\youtube\yelo code\ideas\resources\views/auth/register.blade.php ENDPATH**/ ?>